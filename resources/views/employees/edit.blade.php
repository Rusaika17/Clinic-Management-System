        ...
        <div class="row">
            <div class="col-lg-12" style="padding: 2%;">
                <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #fbfafa;">Edit Employee
                        <a class="btn btn-primary pull-right" href="{{route('employee.index')}}"><span
                        ...
                        <div class="container">
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class=" col-md-4 form-group">
                                        <label>NIC:</label>
                                        {!! Form::text('nic', null, array('class' => 'form-control')) !!}
                                    </div>
                                    <div class=" col-md-4 form-group">
                                ...
                                <div class="modal-footer">
                                    ...
                                    {{Form::close()}}
                                    <a class="btn btn-danger pull-left" id="delete_employee"><span
