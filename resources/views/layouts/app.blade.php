...
<head>
    ...
    <title>{{ config('app.name', 'Medi Care Clinic') }}</title>
...
<body>
<nav style="background-color: #286594;" class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('dashboard.index')}}" style="font-size: xx-large">Medi Care Clinic</a>
        </div>

        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav" style="background-color: #c8ccd0;">
                <li class="active"><a href="{{route('dashboard.index')}}">Dashboard</a></li>
                <li class="active"><a href="{{route('employee.index')}}">Employees</a></li>
...
{{--                        <li><a href="{{route('employee.index')}}">Employees</a></li>--}}
                        ...
                        <li><a href="{{route('department.index')}}">Doctor Specializations</a></li>
